            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Nueva Categoria</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form action="<?php echo base_url(); ?>mantenimiento/categorias/store" method="post">
                                            <div class="form-group <?php echo !empty(form_error("nombre"))? 'has-danger': '' ?>">
                                                ...
                                                <input type="text" name="nombre" class="form-control <?php echo !empty(form_error("nombre"))? 'form-control-danger': '' ?>" value="<?php echo set_value("nombre"); ?>">
